  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <h2 className="text-2xl font-bold text-gray-800 mb-4">
      {activeRoute === '/admin' ? 'Dashboard' : 
       activeRoute === '/admin/drives' ? 'Placement Drives' :
       activeRoute === '/admin/offers' ? 'My Offers' :
       activeRoute === '/admin/resume' ? 'My Resume' :
       activeRoute === '/admin/profile' ? 'Profile' :
       activeRoute === '/admin/settings' ? 'Settings' : 'Dashboard'}
    </h2>
    <div className="text-gray-600">
      <p className="mb-4">Welcome to your {activeRoute === '/admin' ? 'dashboard' : activeRoute.split('/').pop()}!</p>
...
export default function AdminLayout() {
  ...
  const navigationItems = [
    ...
    { icon: BriefcaseBusiness, label: 'Drives', path: '/admin/drives' },
    { icon: Calendar, label: 'Offers', path: '/admin/offers' },
    { icon: FileText, label: 'Resumes', path: '/admin/resume' },

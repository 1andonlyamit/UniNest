  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <h2 className="text-2xl font-bold text-gray-800 mb-4">
      {activeRoute === '/student' ? 'Dashboard' : 
       activeRoute === '/student/drives' ? 'Placement Drives' :
       activeRoute === '/student/offers' ? 'My Offers' :
       activeRoute === '/student/resume' ? 'My Resume' :
       activeRoute === '/student/profile' ? 'Profile' :
       activeRoute === '/student/settings' ? 'Settings' : 'Dashboard'}
    </h2>
    <div className="text-gray-600">
      <p className="mb-4">Welcome to your {activeRoute === '/student' ? 'dashboard' : activeRoute.split('/').pop()}!</p>
...
export default function StudentLayout() {
  ...
  const navigationItems = [
    ...
    { icon: BriefcaseBusiness, label: 'Drives', path: '/student/drives' },
    { icon: Calendar, label: 'Offers', path: '/student/offers' },
    { icon: FileText, label: 'Resumes', path: '/student/resume' },
